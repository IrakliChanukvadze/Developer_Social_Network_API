...
const checkUserPermission = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    const userFromBase = yield user_model_1.User.findOne({
        //@ts-ignore
        where: { email: req === null || req === void 0 ? void 0 : req.user.email },
    });
    //@ts-ignore
    const permision = userFromBase.email === (req === null || req === void 0 ? void 0 : req.user.email);
    if (permision) {
        next();
    }
    else {
...
//# sourceMappingURL=checkUserPermision.js.map